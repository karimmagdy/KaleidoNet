"""Train KaleidoNet on Tiny-ImageNet classification.

Run:
    python run.py experiments/baselines/train_tiny_imagenet.py --data-dir ./data/tiny-imagenet-200
    python run.py experiments/baselines/train_tiny_imagenet.py --data-dir ./data --seed 42
"""
...
def main():
    parser = argparse.ArgumentParser(description="Train KaleidoNet on Tiny-ImageNet")
    ...
    print("=" * 60)
    print("KaleidoNet Tiny-ImageNet Training")
    print("=" * 60)
    ...
    result_path = f"results/kaleidonet_tiny_imagenet{suffix}.json"
