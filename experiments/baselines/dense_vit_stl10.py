"""Dense ViT baseline for STL-10.

Run:
    python experiments/baselines/dense_vit_stl10.py --seed 1 --steps 5000
"""
...
def main():
    parser = argparse.ArgumentParser(description="Dense ViT baseline for STL-10")
    ...
    print("=" * 60)
    print("Dense ViT Baseline — STL-10")
    print("=" * 60)
    ...
    result_path = f"results/dense_vit_stl10{suffix}.json"
